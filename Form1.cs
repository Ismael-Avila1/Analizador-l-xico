    ...
    public partial class Form1 : Form
    {
        ...
        void detalles(int estado, string cadena)
        {
            ...
            if (estado == ERROR) // si es el estado de error
                MessageBox.Show("La cadena ingresada es inv�lida", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);

            else if(estado == Q2) { // si es el estado final Q2
                string s = "La cadena ingresada es un n�mero. " + "Los detalles de la cadena son los siguientes: \n\n";
                s += "� Es un n�mero con signo positivo\n";
                s += "� Es un n�mero entero\n";
                s += "� El valor del n�mero es: ";
                ...
                bool isReal = false;
                string s = "La cadena ingresada es un n�mero. \n" + "Los detalles de la cadena son los siguientes: \n\n";


                if(cadena[0].ToString() == "-")
                    s += "� Es un n�mero con signo negativo\n";
                else
                    s += "� Es un n�mero con signo positivo\n";
                ...
                string s = "La cadena ingresada es una asignaci�n de variable con un entero. " + "Los detalles de la cadena son los siguientes: \n\n";
                ...
                s += "\n� El operador '=' es un operador de asignaci�n\n";

                s += "� El valor asignado a la variable es una operaci�n entre dos n�meros\n";
                ...
                s += "\n� El s�mbolo ';' es s�mbolo terminal\n";
                ...
                string s = "La cadena ingresada es una asignaci�n de variable con un real. " + "Los detalles de la cadena son los siguientes: \n\n";
                ...
                string s = "La cadena ingresada es una asignaci�n de variable con otra variable. " + "Los detalles de la cadena son los siguientes: \n\n";
                ...
                s += "� if es la instrucci�n de comparaci�n\n";
                ...
                s += "\n� El operador usado para la comparaci�n es: ";
